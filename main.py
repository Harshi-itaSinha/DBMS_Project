...
def info():
    ...
    cur.execute("insert into login values (%s,%s,%s)", (userid, username, password))
...
def insert():
    ...
    # cur.execute("INSERT INTO tracker (%s, %s, %s)", (product_id, product_url, expected_price))
    cur.callproc('add_product', (product_name, product_url, expected_price, cur_price, uid, product_id))
